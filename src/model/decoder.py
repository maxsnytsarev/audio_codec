...
class Decoder(nn.Module):
    def __init__(self, D, C):
        ...
        self.conv1 = causalConv(
            in_channels=D, out_channels=16 * C, kernel=7, stride=1, dilation=1
        )
        ...
        self.conv2 = causalConv(
            in_channels=C, out_channels=1, kernel=7, stride=1, dilation=1
        )
